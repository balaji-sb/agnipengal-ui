        ...
        <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-100">
                {loading ? (
                    ...
                    <tr><td colSpan={4} className="p-8 text-center text-gray-500">No pages found.</td></tr>
                ) : pages.map((page: any) => (
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-xl animate-in fade-in zoom-in duration-200">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center sticky top-0 bg-white z-10">
                    <h2 className="text-xl font-bold text-gray-900">{currentId ? 'Edit Page' : 'Create New Page'}</h2>
