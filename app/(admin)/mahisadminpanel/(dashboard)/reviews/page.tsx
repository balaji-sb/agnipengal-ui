    ...
    <div className='space-y-6'>
      ...
      <div className='bg-white p-4 rounded-xl shadow-sm border border-gray-100'>
        <form onSubmit={handleFilterSubmit} className='flex flex-wrap gap-4 items-end'>
          ...
          <button
            type='submit'
            className='px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition flex items-center space-x-2 h-[42px]'
          >
                  ...
                  <tr key={review._id} className='hover:bg-gray-50 transition'>
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <div className='flex items-center space-x-3'>
                        ...
                        <div>
                          <div
                            className='font-medium text-gray-900 line-clamp-1 max-w-[150px]'
                    ...
                    <td className='px-6 py-4'>
                      <p
                        className='text-sm text-gray-600 line-clamp-2 max-w-xs mb-2'
                      ...
                      {review.media && review.media.length > 0 && (
                        <div className='flex gap-2'>
                          {review.media.map((item, idx) => (
                            <div
                              key={idx}
                              className='w-10 h-10 rounded border border-gray-200 overflow-hidden bg-gray-50 flex-shrink-0 cursor-pointer'
