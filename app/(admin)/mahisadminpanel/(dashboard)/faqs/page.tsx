  ...
  return (
    <div className='max-w-5xl mx-auto'>
      <div className='flex justify-between items-center mb-8'>
        ...
        <Link
          href='/mahisadminpanel/faqs/new'
          className='flex items-center space-x-2 px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition shadow-md hover:shadow-lg'
        >
                ...
                <div className='flex justify-between items-start gap-4'>
                  <div className='flex-1'>
                    <div className='flex items-center gap-2 mb-1'>
                      <span
                        className={`px-2 py-0.5 text-xs font-bold rounded-full ${faq.isActive ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'}`}
                      >
                  ...
                  <div className='flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity'>
                    <Link
                      href={`/mahisadminpanel/faqs/${faq._id}`}
