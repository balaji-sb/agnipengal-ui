    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex space-x-3">
             <ImportExportButtons entity="products" onSuccess={() => fetchProducts()} />
            <Link 
                href="/mahisadminpanel/products/new" 
                ...
                {loading ? (
                    ...
                    <tr key={product._id} className="hover:bg-gray-50 transition">
                        ...
                        <td className="p-4 flex space-x-2">
                             <Link href={`/mahisadminpanel/products/${product._id}`} className="p-2 text-blue-600 hover:bg-blue-50 rounded inline-flex">
