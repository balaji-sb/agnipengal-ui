  ...
  return (
    <div>
      <div className='flex justify-between items-center mb-8'>
        ...
        <Link
          href='/mahisadminpanel/email-templates/new'
              ...
              templates.map((template: any) => (
                <tr key={template._id} className='hover:bg-gray-50 transition'>
                  ...
                  <td className='p-4 text-gray-700'>
                    <span
                      className={`px-2 py-1 rounded text-xs ${template.isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}
                    >
                  ...
                  <td className='p-4 flex space-x-2'>
                    <Link
                      href={`/mahisadminpanel/email-templates/${template._id}`}
