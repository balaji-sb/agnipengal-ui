        ...
        <div className='bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-fit'>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex items-center gap-2'>
                  <label
                    className={`flex-1 flex items-center justify-center gap-2 p-2.5 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-pink-500 hover:bg-pink-50 transition-all ${uploading ? 'opacity-50 pointer-events-none' : ''}`}
                  >
                    <input
                      type='file'
                      accept='image/*'
            ...
            <button
              type='submit'
              disabled={submitting}
              className={`w-full text-white py-2.5 rounded-lg font-bold transition disabled:opacity-50 disabled:cursor-not-allowed mt-4 ${editingId ? 'bg-blue-600 hover:bg-blue-700' : 'bg-orange-600 hover:bg-orange-700'}`}
            >
          ...
          {loading ? (
            ...
            <>
              {items.map((item) => (
                <div
                  key={item._id}
                  className='bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4 group hover:shadow-md transition-all'
                >
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    <div className='flex items-center gap-3 text-sm text-gray-500 mt-1'>
                      ...
                      <span className='truncate max-w-[150px] text-xs text-blue-500 hover:underline'>
                        {item.link}
                      </span>
                    </div>
                  </div>
