        ...
        <div className='space-y-6'>
          <div className='bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-fit sticky top-6'>
            ...
            <form onSubmit={handleSaveCategory} className='space-y-4'>
              ...
              <button
                type='submit'
                className='w-full bg-orange-600 text-white py-2 rounded-lg font-bold hover:bg-orange-700 transition flex items-center justify-center'
              >
                {editingCategory ? (
                ...
                <div className='bg-gray-50 p-3 rounded-lg border border-gray-200'>
                  ...
                  <form onSubmit={handleSaveSubcategory} className='space-y-3'>
                    ...
                    <div className='flex space-x-2'>
                      <button
                        type='submit'
                        className='flex-1 bg-gray-800 text-white py-1.5 rounded text-sm font-medium hover:bg-gray-900'
                      >
                      ...
                      {editingSubId && (
                        <button
                          ...
                          className='bg-gray-200 text-gray-600 px-3 py-1.5 rounded text-sm font-medium hover:bg-gray-300'
                        >
                          Cancel
                        </button>
                      )}
