  ...
  return (
    <div className='p-6'>
      <div className='flex justify-between items-center mb-8'>
        ...
        <Link
          href='/mahisadminpanel/coupons/new'
          ...
          <tbody className='divide-y divide-gray-50'>
            {coupons.map((coupon) => (
              <tr key={coupon._id} className='hover:bg-gray-50/50'>
                ...
                <td className='p-4'>
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-bold ${coupon.isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}
                  >
