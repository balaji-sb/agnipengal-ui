  ...
  return (
    <div className='space-y-6 pb-20'>
      ...
      <div className='bg-white rounded-xl shadow-sm border border-gray-100 p-6'>
        <h2 className='text-lg font-semibold mb-6 pb-2 border-b border-gray-100'>
        ...
        <form onSubmit={handleSubmit} className='space-y-6 max-w-4xl'>
            ...
            <div className='md:col-span-2'>
              <ImageUpload
                ...
                onChange={(url: string | string[]) =>
                  setFormData({ ...formData, logo: url as string })
                }
                multiple={false}
                folder='branding'
              />
              <p className='text-xs text-gray-500 mt-2'>
                Recommended size: 512x512px (Square), Transparent PNG
              </p>
            </div>
          ...
          <div className='sticky bottom-6 flex justify-end'>
            <button
              type='submit'
              disabled={saving}
              className={`flex items-center gap-2 px-8 py-3 bg-orange-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl hover:bg-orange-700 transition transform hover:-translate-y-1 ${saving ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
              {saving ? (
                <>
