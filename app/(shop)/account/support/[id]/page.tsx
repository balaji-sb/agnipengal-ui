          ...
          {ticket.messages.map((msg: any, index: number) => {
            ...
            return (
              <div key={index} className={`flex ${isAdmin ? 'justify-start' : 'justify-end'}`}>
                <div
                  className={`flex max-w-[80%] ${isAdmin ? 'flex-row' : 'flex-row-reverse'} gap-3`}
                >
                  <div
                  ...
                  >
                    ...
                    <div
                      className={`text-[10px] mt-2 opacity-70 flex items-center gap-1 ${isAdmin ? 'justify-start' : 'justify-end'}`}
                    >
          ...
          <div className='relative flex gap-3 items-end'>
            ...
            <div className='flex-1 relative'>
              ...
              <textarea
                ...
                placeholder={
                  ticket.status === 'Closed' ? 'This ticket is closed' : 'Type your reply...'
                }
