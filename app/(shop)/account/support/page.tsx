                ...
                <div className='flex justify-between items-center'>
                  <div className='flex-1 min-w-0'>
                    <div className='flex items-center gap-3 mb-1'>
                      <span
                        className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${getStatusColor(ticket.status)}`}
                      >
                        {ticket.status}
                      </span>
            ...
            <form onSubmit={handleSubmit} className='p-6 space-y-6'>
              ...
              <div>
                ...
                {formData.attachment ? (
                  ...
                  <label
                    className={`inline-flex items-center gap-2 px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 cursor-pointer ${uploading ? 'opacity-50' : ''}`}
                  >
                    {uploading ? (
