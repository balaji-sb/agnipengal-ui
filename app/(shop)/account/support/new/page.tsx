        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='pt-4'>
            <button
              type='submit'
              disabled={loading}
              className='w-full bg-orange-600 text-white font-bold py-3 rounded-xl hover:bg-orange-700 transition flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed'
            >
              {loading ? (
                <>
