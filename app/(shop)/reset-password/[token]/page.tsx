        ...
        {status === 'success' ? (
          ...
          <form className='mt-8 space-y-6' onSubmit={handleSubmit}>
            ...
            <button
              ...
              className='w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition disabled:opacity-70'
            >
              {status === 'loading' ? (
