...
import { Phone, Mail, Grid, Store, AlertCircle } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // 1. Fetch Vendor Details (backend `getPublicVendorById` supports ID or Slug)
                  ...
                  <div className='aspect-square relative flex items-center justify-center bg-gray-50 p-4'>
                    ...
                    {product.stock === 0 ? (
                      <div className='absolute inset-0 bg-white/60 flex items-center justify-center z-10'>
                        <span className='bg-gray-800 text-white text-xs font-bold px-3 py-1.5 rounded-md shadow-sm'>
                          OUT OF STOCK
                        </span>
                      </div>
                      ...
                      <button
                        className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${
                          product.stock === 0
                            ...
                            : 'bg-gray-100 text-gray-500 group-hover:bg-orange-600 group-hover:text-white'
                        }`}
