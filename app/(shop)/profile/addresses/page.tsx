...
export default function AddressesPage() {
  ...
  const [addressFormData, setAddressFormData] = useState({
      street: '', city: '', state: '', zipCode: '', country: '', isDefault: false, type: 'Home'
  });
  ...
  const handleAddressSubmit = async (e: React.FormEvent) => {
      ...
      try {
          ...
          setAddressFormData({ street: '', city: '', state: '', zipCode: '', country: '', isDefault: false, type: 'Home' });
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8">
            ...
            {loadingAddresses ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {addresses.map((addr) => (
                        <div key={addr._id} className="border border-gray-200 rounded-lg p-4 relative group hover:shadow-md transition bg-white">
                            {addr.isDefault && (
