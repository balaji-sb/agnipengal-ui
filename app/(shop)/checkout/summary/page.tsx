             ...
             <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
                <div className="flex-1 space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <button onClick={() => router.push('/checkout')} className="text-pink-600 text-sm font-medium hover:underline">Edit</button>
                        </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-4">
                            {items.map((item) => (
                                <div key={item.product._id} className="flex gap-4 border-b border-gray-50 pb-4 last:border-0 last:pb-0">
                                    ...
                                    <div className="font-bold text-gray-900">₹{item.product.price * item.quantity}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="w-full lg:w-96 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        {appliedCoupon && <p className="text-green-600 text-sm mt-2 font-medium">Coupon applied successfully!</p>}
                    </div>
