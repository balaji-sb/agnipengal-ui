    ...
    return (
      <div className='min-h-screen bg-gray-50 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <Link href='/deals' className='text-pink-600 hover:underline'>
            Back to Deals
          </Link>
        </div>
      </div>
  ...
  const dealProducts = (deal.products || []).map((p: any) => ({
    ...
    category:
      typeof p.category === 'string'
        ? { name: 'Deal Item', slug: 'deals' }
        : p.category || { name: 'Deal Item', slug: 'deals' },
  }));
    ...
    <div className='bg-gray-50 min-h-screen pb-20'>
      ...
      <div className='relative bg-gray-900 text-white py-16'>
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          <div className='mt-8 flex items-center gap-4'>
            <div className='bg-orange-600 px-6 py-2 rounded-full font-bold text-lg flex items-center gap-2 shadow-lg'>
      ...
      <div className='container mx-auto px-4 py-12'>
        <h2 className='text-2xl font-bold text-gray-800 mb-8 flex items-center gap-2'>
          Items in this Deal{' '}
          <span className='text-sm font-normal text-gray-500'>({dealProducts.length} items)</span>
        </h2>
        ...
        {dealProducts.length > 0 ? (
          ...
          <div className='text-center py-20 text-gray-500'>No products found in this deal.</div>
        )}
      </div>
    </div>
  );
