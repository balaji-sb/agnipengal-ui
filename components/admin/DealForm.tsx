...
export default function DealForm({ initialData, isEditing = false }: DealFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isEditing) {
                await api.put(`/deals/${initialData._id}`, formData);
            } else {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 max-w-4xl mx-auto">
            <h2 className="text-xl font-bold mb-6">{isEditing ? 'Edit Deal' : 'Create New Deal'}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                    <label className="block text-sm font-medium mb-2">Select Products for Deal</label>
