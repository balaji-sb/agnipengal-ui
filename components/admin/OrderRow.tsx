...
export default function OrderRow({ order, isVendor = false }: OrderRowProps) {
          ...
          {order.items.length > 0 ? (
            <div>
              <p
                ...
                title={order.items[0].product?.name || order.items[0].name}
              >
              ...
              <div className='p-6 space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 p-4 rounded-xl'>
                  ...
                  <div className='text-right'>
                    ...
                    <span
                      className={`inline-block px-3 py-1 rounded-full text-sm font-bold ${statusColors[orderStatus as keyof typeof statusColors] || 'bg-gray-200'}`}
                    >
                      {orderStatus}
                    </span>
                  </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    <div className='text-sm text-gray-600 space-y-1'>
                      ...
                      <p>
                        <span className='font-medium'>Phone:</span> {order.customer?.mobile}
                      </p>
                    </div>
                  </div>
                  <div>
                          ...
                          <tr key={i}>
                            <td className='p-3'>
                              <p className='font-medium text-gray-900'>
                                {item.product?.name || item.name || 'Product Deleted'}
                              </p>
                              {item.variant && (
