      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            {/* Search Bar - Desktop */}
            <form action="/products" className="hidden lg:block relative group">
                 <input 
                    type="text" 
                    name="search"
                    placeholder="Search for sarees..." 
                    className="pl-10 pr-4 py-2 bg-gray-50/50 border-0 rounded-full text-sm focus:bg-white focus:ring-2 focus:ring-pink-500/20 outline-none w-48 transition-all focus:w-64 focus:shadow-md placeholder-gray-400 text-gray-700"
                />
                <Search className="absolute left-3 top-2.5 h-4 w-4 text-gray-400 group-focus-within:text-pink-500 transition-colors" />
            </form>
