    ...
    <div className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col h-full">
      <div className="relative aspect-video overflow-hidden bg-gray-100">
        ...
        <div className="absolute bottom-4 left-4 right-4 text-white">
            <h3 className="text-xl font-bold mb-1 leading-tight group-hover:text-yellow-300 transition-colors">{deal.name}</h3>
             {deal.description && (
      ...
      <div className="p-5 flex flex-col flex-grow">
        <div className="mt-auto">
            <Link 
                href={`/deals/${deal._id}`}
                className="w-full flex items-center justify-center gap-2 bg-gray-50 text-gray-900 hover:bg-pink-600 hover:text-white py-3 rounded-xl font-bold transition-all duration-300 group-hover:shadow-lg transform group-hover:-translate-y-1"
            >
