          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <button
                ...
                className='w-full py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold rounded-xl hover:opacity-90 transition shadow-lg shadow-pink-500/20 disabled:opacity-70 flex items-center justify-center gap-2'
              >
